...
const Navigation: React.FC = () => {
  ...
  return (
    <motion.nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-sm shadow-md' : 'bg-transparent'}`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <a href="#home" aria-label="Go to home" className="text-2xl font-bold transition-colors duration-300 font-serif tracking-wide text-white" style={{ color: 'black', textShadow: '1px 1px 2px rgba(0,0,0,0.8)' }}>
              The Asset Studio
            </a>
          </div>
